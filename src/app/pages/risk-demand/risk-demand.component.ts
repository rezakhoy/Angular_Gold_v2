...
@Component({
  ...
  templateUrl: './risk-demand.component.html',
  styleUrls: ['./risk-demand.component.scss'],
})

export class RiskDemandComponent implements OnInit {
  ...
  ngOnInit() {
    this.titleService.setTitle(" لیست  معاملات ریسکی ")
  ...
  //   this.reportService.getRiskList()
  //     .subscribe(data => {
  //         console.log(data);
  //         this.displaySpinner=false;
