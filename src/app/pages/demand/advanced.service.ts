...
//  */
// function sort(tables: IDemand[], column: string, direction: string): Demand[] {
//     if (direction === '' || column === '') {
//         return tables;
//     } else {
...
//     // tslint:disable-next-line: variable-name
//     private _tables$ = new BehaviorSubject<Demand[]>([]);
//     // tslint:disable-next-line: variable-name
...
//      * Search Method
//      */
//     private _search(): Observable<DemandSearchResult> {
//         const { sortColumn, sortDirection, pageSize, page, searchTerm } = this._state;
//
//         // 1. sort
//         let tables = sort(this.demands, sortColumn, sortDirection);
//
//         // 2. filter
